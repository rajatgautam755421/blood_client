    ...
    <>
      {show && (
        <div
          ...
          role="alert"
        >
          <strong>Your Regsitration Has Been Successfully Done.</strong>
          <button
            type="button"
            className="btn-close"
      ...
      <div className="container-fluid mt-4">
        <h1 className="sm:text-3xl text-2xl font-medium title-font mb-4 text-gray-900 text-center">
          <span className="font-bold text-red-600">
            <Typewriter
              options={{
                strings: ["Blood Donor Registration Form"],
                autoStart: true,
                loop: true,
              }}
            />
              ...
              <form className="w-full max-w-lg">
                <div className="flex flex-wrap -mx-3 mb-6">
                  ...
                  >
                    ...
                    <div className="relative">
                      <input
                        ...
                        datepicker-autohide
                        type="date"
                        className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline datepicker-input"
                  ...
                  >
                    ...
                    >
                      Last Donated(
                      <span style={{ color: "green" }}>In days</span>)
                    </label>
                    <input
                      className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                      id="username"
                  ...
                  >
                    ...
                    <label
                      ...
                      style={{ color: "gray" }}
                    >
                      Allergies <span style={{ color: "red" }}>*</span>
                    </label>
                    <input
                      className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                      id="username"
                  ...
                  >
                    ...
                    <label
                      ...
                      style={{ color: "gray" }}
                    >
                      Cardiac <span style={{ color: "red" }}>*</span>
                    </label>
                    <input
                      className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                      id="username"
                  ...
                  >
                    ...
                    <label
                      ...
                      style={{ color: "gray" }}
                    >
                      Bleeding <span style={{ color: "red" }}>*</span>
                    </label>
                    <input
                      className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                      id="username"
